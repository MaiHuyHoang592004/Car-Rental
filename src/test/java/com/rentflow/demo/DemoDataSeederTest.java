...
class DemoDataSeederTest {
    ...
    void runCreatesSixPublicListingsWhenMissing() {
        ...
        when(userRoleRepository.existsByUserIdAndRole(any(UUID.class), eq(Role.HOST))).thenReturn(false);
    ...
    void runDoesNothingWhenDisabled() {
        ...
        verifyNoInteractions(authUserRepository, vehicleRepository, listingRepository);
    }
